...
import wtmf_oos_report as report


class RunExperimentTests(unittest.TestCase):
    def _sixteen_year_prices(self, seed=79, drift=0.0002, scale=0.006):
        dates = pd.bdate_range("2011-01-05", periods=252 * 16, tz="UTC")
    ...
    def test_rejects_history_shorter_than_fifteen_years(self):
        dates = pd.bdate_range("2011-01-05", periods=252 * 10, tz="UTC")
