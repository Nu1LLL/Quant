"""Run the preregistered GLD gold risk-premium first-read OOS study.
...
since GLD's history is long enough to support it).
"""
...
def main():
    ...
    output = root / "reports/mini_medallion_gold_oos"
    inputs = output / "inputs"
    prices = load_adjusted_close(
        "GLD", "2004-11-01", "2026-09-12", cache_folder=inputs, refresh=False
    )
